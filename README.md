...
- **复制给 AI**：一键复制题目、参考答案、全部作答文件、笔记、学习状态和原始 JSON。
...
题库是一个 UTF-8 编码的 JSON 文件，最大 20 MiB，最多包含 10,000 道题。完整约束请查看 [`schemas/question-bank.schema.json`](schemas/question-bank.schema.json)。
